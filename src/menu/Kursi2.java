...
public class Kursi2 extends javax.swing.JFrame {
    ...
    void check(){
        try{
        f = new File("kursi2.txt");
        fr = new FileReader("kursi2.txt");
    ...
    void cetaktiket(String kur){
        ...
        String[] tik1;
        while(pisahkal[1]!= null){
            tik1 = pisahkal[1].split("#");
            pw.append("Tiket "+"\n"+
                    "======================"+"\n"+
                    "Judul Film : "+ tik1[0]+"\n"+
                    "Waktu : "+ tik1[1]+"\n"+
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pilih Kursi Studio B");
    ...
    private void btnclrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnclrActionPerformed
        ...
        FileWriter fw = new FileWriter("kursi2.txt");
        PrintWriter pw =new PrintWriter(fw);
       
        FileWriter fw2 = new FileWriter("tiketB.txt");
