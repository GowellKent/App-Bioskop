...
public class Kursi4 extends javax.swing.JFrame {
    ...
    void check(){
        try{
        f = new File("kursi4.txt");
        fr = new FileReader("kursi4.txt");
    ...
    void cetaktiket(String kur){
        ...
        String[] tik1;
        while(pisahkal[3]!= null){
            tik1 = pisahkal[3].split("#");
            pw.append("Tiket "+"\n"+
                    "======================"+"\n"+
                    "Judul Film : "+ tik1[0]+"\n"+
                    "Waktu : "+ tik1[1]+"\n"+
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pilih Kursi Studio D");
    ...
    private void btnclrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnclrActionPerformed
        ...
        FileWriter fw = new FileWriter("kursi4.txt");
        PrintWriter pw =new PrintWriter(fw);
        
        FileWriter fw2 = new FileWriter("tiketD.txt");
