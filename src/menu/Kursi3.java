...
public class Kursi3 extends javax.swing.JFrame {
    ...
    void check(){
        try{
        f = new File("kursi3.txt");
        fr = new FileReader("kursi3.txt");
    ...
    void cetaktiket(String kur){
        ...
        String[] tik1;
        while(pisahkal[2]!= null){
            tik1 = pisahkal[2].split("#");
            pw.append("Tiket "+"\n"+
                    "======================"+"\n"+
                    "Judul Film : "+ tik1[0]+"\n"+
                    "Waktu : "+ tik1[1]+"\n"+
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pilih Kursi Studio C");
    ...
    private void btnclrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnclrActionPerformed
        ...
        FileWriter fw = new FileWriter("kursi3.txt");
        PrintWriter pw =new PrintWriter(fw);
        
        FileWriter fw2 = new FileWriter("tiketC.txt");
